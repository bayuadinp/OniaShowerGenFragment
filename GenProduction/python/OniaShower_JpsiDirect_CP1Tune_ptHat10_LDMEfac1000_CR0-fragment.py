...
# GenXsecAnalyzer:
# ------------------------------------
# Before Filter: total cross section = 2.581e+09 +- 5.064e+07 pb
# Filter efficiency (taking into account weights)= (4.6838) / (33.546) = 1.396e-01 +- 1.121e-02
# Filter efficiency (event-level)= (161) / (1025) = 1.571e-01 +- 1.137e-02    [TO BE USED IN MCM]

# After filter: final cross section = 3.604e+08 +- 2.979e+07 pb
# After filter: final fraction of events with negative weights = 0.000e+00 +- 0.000e+00
# After filter: final equivalent lumi for 1M events (1/fb) = 2.775e-06 +- 2.294e-07
