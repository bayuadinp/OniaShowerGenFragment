...
# GenXsecAnalyzer:
# ------------------------------------
# Before Filter: total cross section = 2.631e+09 +- 5.189e+07 pb
# Filter efficiency (taking into account weights)= (4.80638) / (33.2292) = 1.446e-01 +- 1.141e-02
# Filter efficiency (event-level)= (165) / (1025) = 1.610e-01 +- 1.148e-02    [TO BE USED IN MCM]

# After filter: final cross section = 3.805e+08 +- 3.093e+07 pb
# After filter: final fraction of events with negative weights = 0.000e+00 +- 0.000e+00
# After filter: final equivalent lumi for 1M events (1/fb) = 2.628e-06 +- 2.137e-07
