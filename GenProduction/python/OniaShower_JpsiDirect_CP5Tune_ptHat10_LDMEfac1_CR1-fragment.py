...
# GenXsecAnalyzer:
# ------------------------------------
# Before Filter: total cross section = 1.779e+09 +- 1.069e+07 pb
# Filter efficiency (taking into account weights)= (0.305626) / (318.524) = 9.595e-04 +- 3.183e-04
# Filter efficiency (event-level)= (11) / (10025) = 1.097e-03 +- 3.307e-04    [TO BE USED IN MCM]

# After filter: final cross section = 1.707e+06 +- 5.663e+05 pb
# After filter: final fraction of events with negative weights = 0.000e+00 +- 0.000e+00
# After filter: final equivalent lumi for 1M events (1/fb) = 5.858e-04 +- 1.943e-04
