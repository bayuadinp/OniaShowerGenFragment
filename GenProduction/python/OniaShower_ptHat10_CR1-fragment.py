...
# GenXsecAnalyzer:
# ------------------------------------
# Before Filter: total cross section = 1.815e+09 +- 3.392e+07 pb
# Filter efficiency (taking into account weights)= (3.617) / (32.7044) = 1.106e-01 +- 1.017e-02
# Filter efficiency (event-level)= (127) / (1025) = 1.239e-01 +- 1.029e-02    [TO BE USED IN MCM]

# After filter: final cross section = 2.008e+08 +- 1.884e+07 pb
# After filter: final fraction of events with negative weights = 0.000e+00 +- 0.000e+00
# After filter: final equivalent lumi for 1M events (1/fb) = 4.981e-06 +- 4.674e-07
