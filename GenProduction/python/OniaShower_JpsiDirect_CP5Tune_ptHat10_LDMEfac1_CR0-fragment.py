...
# GenXsecAnalyzer:
# ------------------------------------
# Before Filter: total cross section = 1.802e+09 +- 1.073e+07 pb
# Filter efficiency (taking into account weights)= (0.149725) / (319.522) = 4.686e-04 +- 2.368e-04
# Filter efficiency (event-level)= (5) / (10025) = 4.988e-04 +- 2.230e-04    [TO BE USED IN MCM]

# After filter: final cross section = 8.443e+05 +- 4.266e+05 pb
# After filter: final fraction of events with negative weights = 0.000e+00 +- 0.000e+00
# After filter: final equivalent lumi for 1M events (1/fb) = 1.184e-03 +- 5.984e-04
