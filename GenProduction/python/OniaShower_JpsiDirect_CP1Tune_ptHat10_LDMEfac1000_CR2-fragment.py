...
# GenXsecAnalyzer:
# ------------------------------------
# Before Filter: total cross section = 2.575e+09 +- 5.083e+07 pb
# Filter efficiency (taking into account weights)= (4.28161) / (33.3223) = 1.285e-01 +- 1.067e-02
# Filter efficiency (event-level)= (159) / (1025) = 1.551e-01 +- 1.131e-02    [TO BE USED IN MCM]

# After filter: final cross section = 3.308e+08 +- 2.823e+07 pb
# After filter: final fraction of events with negative weights = 0.000e+00 +- 0.000e+00
# After filter: final equivalent lumi for 1M events (1/fb) = 3.023e-06 +- 2.580e-07
