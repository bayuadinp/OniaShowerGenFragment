...
# GenXsecAnalyzer:
# ------------------------------------
# Before Filter: total cross section = 2.659e+09 +- 1.627e+07 pb
# Filter efficiency (taking into account weights)= (0.134292) / (326.071) = 4.118e-04 +- 1.938e-04
# Filter efficiency (event-level)= (5) / (10025) = 4.988e-04 +- 2.230e-04    [TO BE USED IN MCM]

# After filter: final cross section = 1.095e+06 +- 5.153e+05 pb
# After filter: final fraction of events with negative weights = 0.000e+00 +- 0.000e+00
# After filter: final equivalent lumi for 1M events (1/fb) = 9.132e-04 +- 4.298e-04
