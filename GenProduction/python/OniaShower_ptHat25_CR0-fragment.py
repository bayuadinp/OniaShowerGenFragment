...
# GenXsecAnalyzer:
# ------------------------------------
# Before Filter: total cross section = 6.656e+07 +- 1.298e+06 pb
# Filter efficiency (taking into account weights)= (2.01932) / (10.4609) = 1.930e-01 +- 1.302e-02
# Filter efficiency (event-level)= (204) / (1005) = 2.030e-01 +- 1.269e-02    [TO BE USED IN MCM]

# After filter: final cross section = 1.285e+07 +- 9.024e+05 pb
# After filter: final fraction of events with negative weights = 0.000e+00 +- 0.000e+00
# After filter: final equivalent lumi for 1M events (1/fb) = 7.783e-05 +- 5.467e-06
